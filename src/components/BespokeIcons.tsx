...
/**
 * BespokeTwitterX - Clean vector representation of the latest X social platform logo.
 */
export const BespokeTwitterX: React.FC<IconProps> = ({ size = 14, className, ...props }) => {
  return (
    <svg
      width={size}
      height={size}
